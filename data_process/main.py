...
def main():
    ...
    df, ner_types = conll_preprocess.preprocess_ace_conll(f"/workspace/datas/{dataset_path}/{split}.json", return_type="json")
    ...
    df.to_csv(f"/workspace/datas/{dataset_path}/{split}.inerd.csv", index=False)
    ...
    # entity type 저장
    #preprocess_utils.save_entity_types(f"/workspace/datas/entity_types.json", "ace05", ner_types)
